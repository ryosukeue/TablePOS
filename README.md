...
TablePOS is an iPad-first, on-device point-of-sale MVP for a single restaurant and a single device. It is implemented with SwiftUI, SwiftData, Vision, and Natural Language. An iPhone-compatible layout is included for testing.
